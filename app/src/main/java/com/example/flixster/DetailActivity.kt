...
private const val YOUTUBE_API_KEY = "AIzaSyCORe_BfiinjrCTPlXTqQqnBt_2F2ovfoI"
...
class DetailActivity : YouTubeBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //get rating of movie
        ratingBar.rating = movie.ratingAverage.toFloat()
        ...
        client.get(TRAILERS_URL.format(movie.movieId), object: JsonHttpResponseHandler(){
            override fun onFailure(
                ...
                Log.e(TAG, "fail to get movie $statusCode")
            }

            override fun onSuccess(statusCode: Int, headers: Headers?, json: JSON) {
                Log.i(TAG, "success to get movie")
        ...
        //get movie in youtube

    }

    private fun initializedYoutube(youtubeKey: String) {
